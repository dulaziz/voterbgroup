<div class="grid grid-cols-3 gap-4 mb-6 items-center">
    <div class="w-full h-72 bg-black rounded-md text-white overflow-hidden flex justify-center items-center">
        <img src="/smpl.jpg" alt="Profile">
    </div>
    <div class="col-span-2 space-y-6">
        <div>
            <label for="helper-text" class="block mb-2 text-sm text-gray-800 dark:text-white">{{$label}}</label>
        ...
        <div>
            <label for="helper-text" class="block mb-2 text-sm text-gray-800 dark:text-white">Upload File</label>
            <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-md cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="user_avatar_help" id="user_avatar" type="file">
            {{-- <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="user_avatar_help">A profile picture is useful to confirm your are logged into your account</div> --}}
        </div>
        <div>
            <label for="helper-text" class="block mb-2 text-sm text-gray-800 dark:text-white">{{$label3}}</label>
            {{$input3}} 
        </div>
    </div>
</div>
...
<form>
    <div class="w-full border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
        ...
        <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
            ...
            <textarea id="editor" rows="8" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Content..." required></textarea>
        </div>
    </div>
</form>