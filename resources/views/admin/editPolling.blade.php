<x-admin-main>
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-xl font-medium">Edit Polling</h1>
        <div class="flex items-center space-x-3">
            <button type="submit" class="inline-flex space-x-1 items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-md focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800">
            ...
            <button type="submit" class="inline-flex space-x-1 items-center px-4 py-2 text-sm font-medium text-center text-white bg-slate-800 rounded-md focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-slate-700">
